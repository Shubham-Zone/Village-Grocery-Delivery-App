...
class _FoodStatusState extends State<FoodStatus> {
  ...
  foodId() async {
    ...
    setState(()  {
      ...
      print("location : $orderLoc , foodlist : $currOrder , id : $id");
    });
      ...
      setState(() {
        dbRef.onValue.listen((DatabaseEvent event) {
          ...
          if (orderstatus == "4") {
            ...
            statustext="Order is packing";
            lottie="order_packing";
            status=true;
            currordervsb=true;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            title: const Text("Order Status",style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold,),),
            centerTitle: true,
  ...
  void onBackPressed() {
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) =>const NavBar(0)));
  }
}
